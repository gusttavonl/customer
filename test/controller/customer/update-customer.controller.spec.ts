...
describe('Update Customer Controller', () => {
  ...
  beforeEach(async () => {
    ...
    updateCustomerAppMock = module.get(
      TYPES.applications.UpdateCustomerApplicationInterface,
    );
  });
  ...
  describe('update', () => {
    it('should update customer', async () => {
      ...
      const customerUpdatedHttpResponse = await controller.update(
        customer.id,
        customerDomainWithId,
        httpResponseMock,
      );
      expect(customerUpdatedHttpResponse.statusCode).toEqual(
        updatedCustomerHttpResponse.statusCode,
      );
