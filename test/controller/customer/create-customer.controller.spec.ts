...
describe('Create Customer Controller', () => {
  ...
  beforeEach(async () => {
    ...
    createCustomerAppMock = module.get(
      TYPES.applications.CreateCustomerApplicationInterface,
    );
  });
  ...
  describe('create', () => {
    it('should create customer', async () => {
      ...
      const customerCreatedHttpResponse = await controller.create(
        customerDataDomain,
        httpResponseMock,
      );
      expect(customerCreatedHttpResponse.statusCode).toEqual(
        createdCustomerResponse.statusCode,
      );
